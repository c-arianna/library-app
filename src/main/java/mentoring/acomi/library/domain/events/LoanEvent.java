...
public sealed interface LoanEvent extends DomainEvent permits LoanRequestedEvent, LoanFailedEvent,
LoanReservedEvent, LoanConfirmedEvent, LoanCanceledEvent {
